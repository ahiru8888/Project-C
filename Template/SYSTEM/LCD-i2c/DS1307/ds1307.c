...
LCD_Result_t LCD_Init(void) {
	/* Initialize clock */
	IIC_Init(LCD_I2C, LCD_I2C_PINSPACK, LCD_I2C_CLOCK);
	
	/* Check if device is connected */
	if (!I2C_IsDeviceConnected(LCD_I2C, LCD_I2C_ADDR)) {
		return LCD_Result_DeviceNotConnected;
	}
...
//	I2C_StartTransmission (LCD_I2C, I2C_Direction_Transmitter, lcdi2c.Addr); //Wire.beginTransmission(_Addr);
//	I2C_WriteData(LCD_I2C, (int)(_data) | lcdi2c.backlightval);  //printIIC((int)(_data) | _backlightval);
//	I2C_GenerateSTOP(LCD_I2C, ENABLE); //Wire.endTransmission();
	I2C_Write(LCD_I2C, lcdi2c.Addr, 0x00, (int)(_data) | lcdi2c.backlightval);
}
